...
public class AppointmentDTO {
    ...
    public AppointmentDTO(Long idAppointment,LocalDateTime  dt_rec, LocalDateTime  dt_ap, String description, Doctor user_doc, Client user_cl, StatusDic status) {
